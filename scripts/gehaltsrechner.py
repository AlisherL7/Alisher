...
rows = [
 ...
 ("N", "Dienstplan", "График месяца: ND / TD / FREI, статус (Arbeit / Urlaub / Krank), «x» = Eingesprungen. Сейчас заполнен СЕНТЯБРЬ 2026: 10 TD + 5 ND = 15 смен = 180 ч."),
 ...
 ("N", "Сверка с расчёткой", "Реальные Lohnabrechnung 07/2026 и 08/2026, разобранные построчно, и проверка каждой суммы. Август зафиксирован числами и не меняется при смене месяца."),
 ("SP",),
...
par("Месяц (1–12)", "Monat", 9, "Monat", "0")
...
par("Переработка включена в оклад (ч)", "pauschal abgegoltene Überstunden", 0, "UeFrei", '0\\ "h"',
    "§ 2 Abs. 3 договора разрешает не платить первые 8 ч/мес. Но в расчётке 08/2026 оплачены ВСЕ 216 ч — поэтому здесь 0. "
    "Поставь 8, если хочешь увидеть минимум по договору")
...
par("Ночь: с (час)", "Nachtarbeit von", 20, "NachtVon", "0", "20 = 20:00. Подтверждено работодателем (Chris, WhatsApp 09/2026): «20:00 – 06:00 morgens Nacht»")
par("Ночь: до (час)", "Nachtarbeit bis", 6, "NachtBis", "0", "6 = 06:00")
par("Воскресная надбавка", "Sonntagszuschlag", 0.50, "ZSonn", FMT_PCT,
    "§ 3 Abs. 2 b). Подтверждено (Chris): «Sonntags Zuschlag ab 00:00» и «Sonntag > als Nacht, dann zählt Sonntag» — надбавки НЕ складываются")
...
# Сентябрь 2026 — по Dienstplan из приложения Supershift.
# 10 TD + 5 ND = 15 смен x 12 ч = 180 ч. Август лежит на листе «Сверка с расчёткой».
PLAN = {1:"TD",2:"TD",3:"FREI",4:"ND",5:"ND",6:"ND",7:"FREI",8:"FREI",9:"TD",10:"TD",
        11:"TD",12:"TD",13:"TD",14:"TD",15:"FREI",16:"FREI",17:"FREI",18:"FREI",19:"FREI",20:"FREI",
        21:"FREI",22:"FREI",23:"TD",24:"TD",25:"FREI",26:"FREI",27:"ND",28:"ND",29:"FREI",30:"FREI",31:"FREI"}
SPRN = set()
...
sv_sec("АВГУСТ — СХОДЯТСЯ ЛИ ЧАСЫ (числа зафиксированы, лист Dienstplan уже за сентябрь)")
sv_head()
h1 = sv_line("Отработано по графику", 216.00, "16 ND + 2 TD = 18 смен × 12 ч", fmt='0.00\\ "h"')
...
s1 = sv_line("Воскресных по графику", 44.00, "", fmt='0.00\\ "h"')
...
sv_text("Работодатель заплатил ЩЕДРЕЕ, чем написано в договоре: § 2 Abs. 3 разрешает не платить первые 8 ч "
        ...
        "Поэтому в «Настройках» «Переработка включена в оклад» стоит 0 — так файл повторяет расчётку. "
        "Поставь 8, если захочешь увидеть, сколько работодатель обязан минимум по договору.")
...
for t in [
  ...
  "· Времена надбавок подтверждены работодателем письменно (Chris, WhatsApp, сентябрь 2026): ночь 20:00–06:00, "
  "воскресенье с 00:00, и при совпадении воскресенья с ночью считается ВОСКРЕСЕНЬЕ. Именно так файл и считает. "
  "Отсюда те 28 часов в августе, что ушли из ночных (25 %) в воскресные (50 %).",
  "· ОТКРЫТО: как оплачивается ПРАЗДНИК. Договор § 3 Abs. 2 даёт +35 % с отгулом (c) или +135 % без отгула (d). "
  "Ни одной расчётки с праздником ещё не было. Первый случай — 03.10.2026, Tag der Deutschen Einheit: 12 праздничных часов, "
  "разница между вариантами ≈ 324 € брутто. Спросить заранее и проверить строку Feiertagszuschlag в расчётке за октябрь.",
